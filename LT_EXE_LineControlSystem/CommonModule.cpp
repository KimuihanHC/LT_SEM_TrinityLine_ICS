...
CEES_PortSubStatus & CCommonModule::Set_mEES_PortSubStatus(__in uint8_t IN_nStatus)
{
	return m_ptEES_PortSubStatus.at(IN_nStatus);
}
void CCommonModule::Set_mEES_PorSubStatus(__in uint8_t IN_nStatus, __in  CEES_PortSubStatus In_DATA)
{
...
CEES_PortSubStatus & CCommonModule::Set_sEES_PortSubStatus() 
{
	return m_EqEES_PortSubStatus;
}
...
CAlarmStatus & CCommonModule::Set_mAlarmStatus(__in uint8_t IN_nStatus)
{
	return m_ptAlarmStatus.at(IN_nStatus);
}
